...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref "Plus-2.8"
  WORKING_DIRECTORY "C:/Project/PlusB-bin/PlusLibData"
...
if("${show_ref_output}" MATCHES "refs/remotes/Plus-2.8")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "Plus-2.8")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "Plus-2.8")
endif()
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/PlusToolkit/PlusLibData.git'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: 'C:/Project/PlusB-bin/PlusLibData'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Project/PlusB-bin/PlusLibData'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
