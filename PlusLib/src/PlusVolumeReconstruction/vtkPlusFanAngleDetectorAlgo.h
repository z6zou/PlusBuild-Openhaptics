...
#ifndef __vtkPlusFanAngleDetectorAlgo_h
#define __vtkPlusFanAngleDetectorAlgo_h
...
*/
class vtkPlusVolumeReconstructionExport vtkPlusFanAngleDetectorAlgo : public vtkObject
{
public:
...
protected: 
  vtkPlusFanAngleDetectorAlgo();
  virtual ~vtkPlusFanAngleDetectorAlgo();
...
private: 
  vtkPlusFanAngleDetectorAlgo(const vtkPlusFanAngleDetectorAlgo&);  // Not implemented.
  void operator=(const vtkPlusFanAngleDetectorAlgo&);  // Not implemented.
}; 
