...
vtkStandardNewMacro( vtkPlusFanAngleDetectorAlgo );

//----------------------------------------------------------------------------
vtkPlusFanAngleDetectorAlgo::vtkPlusFanAngleDetectorAlgo()
{
  this->Image = NULL;
...
//----------------------------------------------------------------------------
void vtkPlusFanAngleDetectorAlgo::PrintSelf( ostream& os, vtkIndent indent )
{
