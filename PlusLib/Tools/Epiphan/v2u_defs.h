/****************************************************************************
 *
 * $Id: v2u_defs.h 14622 2011-10-28 21:34:50Z rekjanov $
 *
...
#if !defined(__KERNEL__) && !defined(__C51__)
#  ifdef _WIN32
#    include <windows.h>
#    include <winioctl.h>
#  else  /* Unix */
...
/*
 * Note that V2UScaleModeWeightedAverage scale mode is EXPERIMENTAL and
...
#define V2U_PROPERTY_LIST(property) \
    ...
    property( V2UKey_InputSignalType,       /* Since 3.23.7.3 */\
              ...
              V2UPropType_Uint32,           \
              V2UPropAccess_RO)             \
    property( V2UKey_DigitalModeDetect,     /* Since 3.24.5, DVI2USB Duo */\
