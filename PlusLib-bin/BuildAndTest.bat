...
"C:/Program Files/CMake/bin/ctest.exe" -C %BUILD_TYPE% -R "%INDIVIDUAL_TEST%" -N %TEST_TRACK%
@REM Run selected tests
"C:/Program Files/CMake/bin/ctest.exe" -C %BUILD_TYPE% -R "%INDIVIDUAL_TEST%" -V %TEST_TRACK%
goto success
