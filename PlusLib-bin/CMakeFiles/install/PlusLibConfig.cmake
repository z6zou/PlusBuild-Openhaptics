...
IF(VTK_FOUND)
  ...
  ENDIF()
ELSE()
  SET(VTK_DIR "${PLUSLIB_INSTALL_PATH}/../../Project/PlusB-bin/vtk-int/lib/cmake/vtk-8.2" CACHE PATH "Path to VTK")
ENDIF()
...
IF(1)
  IF(ITK_FOUND)
    ...
    ENDIF()
  ELSE()
    SET(ITK_DIR "${PLUSLIB_INSTALL_PREFIX}/../../Project/PlusB-bin/itk-int/lib/cmake/ITK-4.12" CACHE PATH "Path to ITK")
  ENDIF()
...
SET(PlusLib_INCLUDE_DIRS "${PLUSLIB_INSTALL_PATH}/include/PlusLib-2.8")
SET(PlusLib_DATA_DIR "${PLUSLIB_INSTALL_PATH}/share/PlusLib-2.8")
...
SET(PlusLib_USE_FILE "${PLUSLIB_PACKAGE_DIR}/UsePlusLib.cmake")
