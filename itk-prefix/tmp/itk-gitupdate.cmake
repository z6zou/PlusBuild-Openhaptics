...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref "v4.12.0"
  WORKING_DIRECTORY "C:/Project/PlusB-bin/itk"
...
if("${show_ref_output}" MATCHES "refs/remotes/v4.12.0")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v4.12.0")
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/InsightSoftwareConsortium/ITK'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: 'C:/Project/PlusB-bin/itk'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Project/PlusB-bin/itk'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
