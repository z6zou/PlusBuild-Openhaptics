...
set(VTK_MODULES_DIR "C:/Project/PlusB-bin/vtk-bin/lib/cmake/vtk-8.2/Modules")
...
set(VTK_CMAKE_DIR "C:/Project/PlusB-bin/vtk/CMake")
...
if (__vtk_install_tree)
  if (WIN32)
    set (VTK_RUNTIME_DIRS "C:/Project/PlusB-bin/vtk-int/bin")
  else ()
    set (VTK_RUNTIME_DIRS "C:/Project/PlusB-bin/vtk-int/lib")
  endif ()
else()
  if (WIN32)
    set (VTK_RUNTIME_DIRS "C:/Project/PlusB-bin/vtk-bin/bin")
  else ()
    set (VTK_RUNTIME_DIRS "C:/Project/PlusB-bin/vtk-bin/lib")
  endif ()
endif()
...
# Import VTK targets.
set(VTK_CONFIG_TARGETS_FILE "C:/Project/PlusB-bin/vtk-bin/VTKTargets.cmake")
if(NOT TARGET vtkCommonCore)
  include("${VTK_CONFIG_TARGETS_FILE}")
endif()

# Load module interface macros.
include("C:/Project/PlusB-bin/vtk/CMake/vtkModuleAPI.cmake")
